...
class FakeRepo(UserPort):
    ...
    def list_users(self, *, q, offset, limit): ...
    def has_card(self, user_id: UUID) -> bool: ...
    def update_searchable(self, user_id, is_nickname_searchable) -> None: ...
    def card_slugs(self, user_ids): return {}

    def search_by_nickname(self, *, q, exclude_user_id, limit): ...
    def find_contact(self, user_a, user_b): ...
    def find_contact_by_id(self, contact_id): ...
    def create_contact_request(self, requester_id, target_id, note): ...
    def accept_contact_request(self, contact_id): ...
    def list_accepted_contacts(self, user_id): ...
    def list_incoming_contact_requests(self, user_id): ...
